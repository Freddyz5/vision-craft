...
export default function SelectedImagesModal({ isOpen, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-df-bg/80 dark:bg-df-bg-dark/80 backdrop-blur-sm flex justify-center items-center p-4 animate-fade-in">
      <div className="bg-df-surface dark:bg-df-surface-dark w-full max-w-5xl h-[80vh] flex flex-col rounded-3xl shadow-2xl border border-df-border dark:border-df-border-dark overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6 bg-df-bg/50 dark:bg-df-bg-dark/50">
        ...
        <div className="border-t border-df-border dark:border-df-border-dark p-4 flex justify-end gap-4 shrink-0 bg-df-surface dark:bg-df-surface-dark">
          <a
            href="/canvas"
