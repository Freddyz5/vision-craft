...
/**
 * The mutually-exclusive export tracks shown in the Export sidebar.
 ...
 *
 * The former "data" (save / JSON) track now lives in the Boards module
 * (`/boards`), where boards are listed, exported and imported as JSON.
 */
export type ExportMode = "poster" | "fit-page" | "image";
